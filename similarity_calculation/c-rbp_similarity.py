...
df = pd.read_excel("data\c-rbp_symbol.xlsx", header=None)
symbol = df.iloc[0].values
pf = pd.read_excel("data\c-rbp_symbol.xlsx")
total_data_list = []
...
np.savetxt("result_data\c-rbp_similarity.txt", total_data_array)
print(1)
